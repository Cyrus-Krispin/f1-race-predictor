...
pd.DataFrame(data={"Name": driver_names, "No": driver_numbers, "Flag": driver_flags, "Short Team Name": driver_teams, "Country": driver_countries, "Podiums": driver_podiums, "Total Points": driver_points, "Total GPs": driver_total_gps, "World Championships": driver_world_championships, "Highest Race Finish": driver_highest_race_finishes, "Highest Grid Position": driver_highest_grid_positions, "Date of Birth": driver_dates_of_birth, "Place of Birth": driver_places_of_birth}).to_csv("driver_details.csv", index=False, header=True)